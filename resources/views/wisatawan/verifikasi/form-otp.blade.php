    ...
    <style>
        * {
        ...
        .container {
            ...
            padding: 30px 10px;
            /* lebih kecil supaya tidak sempit */
            border-radius: 20px;
        ...
        .otp-input-container {
            ...
            /* agar tidak turun */
            overflow-x: auto;
            /* bisa scroll kanan kiri kalau terlalu sempit */
            margin-bottom: 5px;
        }
...
<body>
    <div class="container">
        <form action="{{ route('wisatawan.otp.verify') }}" method="POST">
            ...
            <p>
                Masukkan 6 dikit kode Verifikasi yang telah dikirim ke inbox email
            </p>
            ...
            <p style="margin-top: 35px">
                Kode Verifikasi akan kedaluwarsa dalam 5 menit
                (<span style="font-weight: bold; color: red;" id="timer"></span>)
            </p>

            <p style="margin-top: -20px">
                Jika Anda tidak menerima kode Verifikasi, silakan <a href="{{ route('wisatawan.otp.resend') }}"
                    class="resend-link">Kirim ulang</a>
            </p>
