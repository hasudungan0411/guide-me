                                    ...
                                    <tbody>
                                        @foreach ($blogs as $blog)
                                            <tr>
                                                ...
                                                <td>{{ $blog->judul }}</td>
                                                <td><span class="badge"
                                                        style="background-color: {!! generateColorFromText($blog->kategori->nama_kategori) !!}; color: #fff;">
                                                        {{ $blog->kategori->nama_kategori }}
                                                    </span></td>
                                                <td>
                                                    <button class="btn btn-sm btn-success" tabindex="0"
                                                        data-toggle="popover" data-trigger="focus" title="Deskripsi Pendek"
                                                        data-content="{{ strip_tags($blog->short_desk) }}">Lihat</button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm btn-success" tabindex="0"
                                                        data-toggle="popover" data-trigger="focus" title="Deskripsi Panjang"
                                                ...
                                                <td>
                                                    <div class="btn-group dropleft">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('blog.show', $blog->slug) }}">Detail</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('blog.edit', $blog->id_blog) }}">Ubah</a>
                                                    ...
                                                    <div class="modal fade" id="modalHapus{{ $blog->id_blog }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('blog.destroy', $blog->id_blog) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
