    ...
    <div class="page-content">
        ...
        <div class="main-wrapper">
            <div class="row stats-row">
                ...
                <div class="col-lg-4 col-md-12 w-100">
                    <div class="card card-transparent stats-card">
                        <div class="card-body">
                            <div class="stats-info">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($destinations as $destination)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge"
                                                        style="background-color: {!! generateColorFromText($destination->kategori->nama_kategori) !!}; color: #fff;">
                                                    ...
                                                    <div class="btn-group dropleft w-100">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('destinasi.show', $destination->id) }}">Detail</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('destinasi.edit', $destination->id) }}">Ubah</a>
                                                            <div class="dropdown-divider"></div>
                                                            <!-- Modal untuk konfirmasi hapus -->
                                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                                data-target="#exampleModalCenter{{ $destination->id }}">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Modal Hapus -->
                                            <div class="modal fade" id="exampleModalCenter{{ $destination->id }}"
