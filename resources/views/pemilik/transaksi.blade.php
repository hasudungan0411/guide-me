            ...
            <div class="row stats-row">
                    ...
                    <div class="card card-transparent stats-card">
                        <div class="card-body">
                            <div class="stats-info">
                                <h5 class="card-title"> {{ $totalTiketTerjual }}
                                    <span class="stats-change stats-change-success">Pembelian Tiket</span>
                                </h5>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card card-transparent stats-card">
                        <div class="card-body">
                            <div class="stats-info">
                                <h5 class="card-title"> Rp. {{ number_format($totalPendapatan, 0, ',', '.') }}
                                    <span class="stats-change stats-change-success">Pendapatan</span>
                                </h5>
                                <p class="stats-text">Total Pendapatan</p>
                            </div>
                            <div class="stats-icon change-success">
                                <i class="material-icons">trending_up</i>
                            </div>
                            ...
                            <table id="zero-conf" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    ">
                                        ...
                                        <!-- Modal Hapus -->
                                        <div class="modal fade" id="ModalHapus{{ $tiket->ID_Transaksi }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('tiket.hapus', $tiket->ID_Transaksi) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                        ...
                                        <!-- Modal Konfirmasi -->
                                        <div class="modal fade" id="ModalPembayaran{{ $tiket->ID_Transaksi }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('tiket.konfirmasi', $tiket->ID_Transaksi) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit"
                                        ...
                                        <!-- Modal Penggunaan -->
                                        <div class="modal fade" id="ModalGunakan{{ $tiket->ID_Transaksi }}"
                                            tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-dismiss="modal">Batal</button>
                                                        <form action="{{ route('tiket.gunakan', $tiket->ID_Transaksi) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit"
                                                                class="btn btn-success">Gunakan</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Modal Bukti -->
                                        <div class="modal fade" id="ModalBukti{{ $tiket->ID_Transaksi }}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalCenterTitle">Bukti
                                                            Pembayaran</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <i class="material-icons">close</i>
                                                    ...
                                                    <div class="modal-body">
                                                        <img src="{{ asset('bukti/' . $tiket->Bukti_Transaksi) }}"
                                                            alt="Bukti Pembayaran" class="img-fluid w-200"
